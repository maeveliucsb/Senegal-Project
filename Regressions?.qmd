...
# example: ab_sf
st_bbox(ab_sf)      # xmin, ymin, xmax, ymax  (spatial extent)
st_crs(ab_sf)       # coordinate reference system
nrow(ab_sf)         # number of features (points/polygons)
st_geometry_type(ab_sf)  # POINT / POLYGON / MULTIPOLYGON, etc.
```
#Cropping to WA
...
make a diagram, stuff you're tryign to link, spatial and temporal detail sof your dataset. if you have trust in governemnt
